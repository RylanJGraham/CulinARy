...
public class AuthManager : MonoBehaviour
{
    ...
    // Reference to ContextManager script
    ...
    void Awake()
    {
        // Check that all necessary dependencies for Firebase are present on the system
    ...
    private IEnumerator Login(string _email, string _password)
    {
        ...
        else
        {
            ...
            // Set verified to true in ContextManager script
            contextManager.verified = true;
        }
    }
